...
def prepare_data(batch_size, data='cifar-100'):
    ...
    if data == 'cifar-100':
        ...
        # set number of worker for efficient data loading 
        ...
        train_loader = DataLoader(train_set, batch_size=batch_size, shuffle=True, drop_last=True,num_workers=10)
        test_loader = DataLoader(test_set, batch_size=batch_size, shuffle=False, drop_last=True,num_workers=10)
